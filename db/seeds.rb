...
review25 = Review.create!({author_id: user6.id, movie_id: movie10.id, body: "Wouldn't it be great if mental illness really was as adorable as it is in the movies?", score: 2.4})
